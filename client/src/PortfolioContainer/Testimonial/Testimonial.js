...
import javascript from "../../../src/img/Testimonial/javascript.jpg";
import CSS3 from "../../../src/img/Testimonial/CSS3.jpg";
import HTML5 from "../../../src/img/Testimonial/HTML5.png";
...
export default function Testimonial(props) {
  ...
  return (
    <div>
      <ScreenHeading
        title={"Skills"}
        subHeading={"Some of my technical skills"}
      />
            ...
            >
              <div className="col-lg-12">
                <div className="testi-item">
                  ...
                  <div className="client-info">
                    <img src={CSS3} alt="no internet connection"></img>
                    <h5>CSS3</h5>
                    {/* <p>CEO InansGlobal</p> */}
                  </div>
                </div>
              ...
              <div className="col-lg-12">
                <div className="testi-item">
                  ...
                  <div className="client-info">
                    <img src={javascript} alt="no internet connection"></img>
                    <h5>Javascript</h5>
                    {/* <p>CEO InansGlobal</p> */}
                  </div>
                </div>
              ...
              <div className="col-lg-12">
                <div className="testi-item">
                  ...
                  <div className="client-info">
                    <img src={SASS} alt="no internet connection"></img>
                    <h5>SASS / SCSS</h5>
                    {/* <p>Bnaker</p> */}
                  </div>
                </div>
